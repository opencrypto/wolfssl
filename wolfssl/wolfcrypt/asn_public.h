...
enum Ctc_SigType {
    ...
    CTC_MLDSA44_ED25519             = 1000,
    CTC_MLDSA44_NISTP256_SHA256     = 1001,
    // CTC_MLDSA44_BPOOL256_SHA256     = 1002,

    CTC_MLDSA65_RSAPSS3072_SHA384   = 1003,
    CTC_MLDSA65_RSA3072_SHA384      = 1004,
    CTC_MLDSA65_RSAPSS4096_SHA384   = 1005,
    CTC_MLDSA65_RSA4096_SHA384      = 1006,
    CTC_MLDSA65_NISTP256_SHA384     = 1007,
    CTC_MLDSA65_BPOOL256_SHA256     = 1008,
    CTC_MLDSA65_ED25519_SHA384             = 1009,

    CTC_MLDSA87_NISTP384_SHA384     = 1010,
    CTC_MLDSA87_BPOOL384_SHA384     = 1011,
    CTC_MLDSA87_ED448               = 1012
};
