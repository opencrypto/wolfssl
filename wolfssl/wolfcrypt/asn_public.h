...
enum Ctc_SigType {
    ...
    CTC_MLDSA44_RSA2048      = 998,
    CTC_MLDSA44_RSAPSS2048   = 999,
    CTC_MLDSA44_ED25519      = 1000,
    CTC_MLDSA44_NISTP256     = 1001,
    CTC_MLDSA44_BPOOL256     = 1002,

    CTC_MLDSA65_RSA3072      = 1003,
    CTC_MLDSA65_RSAPSS3072   = 1004,
    CTC_MLDSA65_NISTP256     = 1005,
    CTC_MLDSA65_BPOOL256     = 1006,

    CTC_MLDSA87_NISTP384     = 1007,
    CTC_MLDSA87_BPOOL384     = 1008,
    CTC_MLDSA87_ED448        = 1009
};
