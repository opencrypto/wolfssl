...
enum Ctc_SigType {
    ...
    CTC_MLDSA44_ED25519      = 998, /* 2.16.840.1.114027.80.8.1.3 - id-MLDSA44-Ed25519-SHA512 */
    CTC_MLDSA44_P256         = 999, /* 2.16.840.1.114027.80.8.1.4 - id-MLDSA44-ECDSA-P256-SHA256 */
};
