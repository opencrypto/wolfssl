...
enum Key_Sum {
    ...
    // ML-DSA Composite
    MLDSA44_RSA2048k       = 900, /* 2.16.840.1.114027.80.8.1.1 - id-MLDSA44-RSA2048-SHA256 - 900 + 1 */
    MLDSA44_RSA3072k       = 901, /* 2.16.840.1.114027.80.8.1.2 - id-MLDSA44-RSA3072-SHA256 - 900 + 2 */
    MLDSA44_ED25519k       = 903, /* 2.16.840.1.114027.80.8.1.3 - id-MLDSA44-Ed25519-SHA512 - 900 + 3*/
    MLDSA44_NISTP256k      = 904, /* 2.16.840.1.114027.80.8.1.4 - id-MLDSA44-ECDSA-P256-SHA256 - 900 + 4 */
    MLDSA44_NISTP384k      = 905, /* 2.16.840.1.114027.80.8.1.5 - id-MLDSA44-ECDSA-P384-SHA384 - 900 + 5 */
    MLDSA44_NISTP521k      = 906,
    WC_MLDSA44_RSAPSS2048k = 900,
    WC_MLDSA44_RSA2048     = 901,
    WC_MLDSA44_ED25519k    = 903,
    WC_MLDSA44_NISTP256k   = 904,
    WC_MLDSA44_BPOOL256k   = 905,
    // Level 3
    WC_MLDSA65_RSAPSS3072k = 906,
    WC_MLDSA65_RSA3072     = 907,
    WC_MLDSA65_NISTP256    = 908,
    WC_MLDSA65_BPOOL256    = 909,
    WC_MLDSA65_ED25519     = 910,
    // Level 5
    WC_MLDSA87_NISTP384    = 911,
    WC_MLDSA87_BPOOL384    = 912,
    WC_MLDSA87_ED448       = 913,
};
