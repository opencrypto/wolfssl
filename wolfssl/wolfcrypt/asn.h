...
enum Key_Sum {
    ...
    // ML-DSA Composite
    MLDSA44_RSA2048k       = 998, /* 2.16.840.1.114027.80.8.1.21 - id-MLDSA44-RSA2048-SHA256 - 78 + 900 + 21 */
    MLDSA44_RSA3072k       = 999, /* 2.16.840.1.114027.80.8.1.22 - id-MLDSA44-RSA3072-SHA256 - 78 + 900 + 22 */
    MLDSA44_ED25519k       = 1000, /* 2.16.840.1.114027.80.8.1.23 - id-MLDSA44-Ed25519-SHA512 - 78 + 900 + 23*/
    MLDSA44_NISTP256k      = 1001, /* 2.16.840.1.114027.80.8.1.24 - id-MLDSA44-ECDSA-P256-SHA256 - 78 + 900 + 24 */
    MLDSA44_NISTP384k      = 1002, /* 2.16.840.1.114027.80.8.1.25 - id-MLDSA44-ECDSA-P384-SHA384 - 78 + 900 + 25 */
    MLDSA44_NISTP521k      = 1003,
    WC_MLDSA44_RSA2048     = 1004,
    WC_MLDSA44_RSAPSS2048k = 1005,
    WC_MLDSA44_ED25519k    = 1006,
    WC_MLDSA44_NISTP256k   = 1007,
    WC_MLDSA44_BPOOL256k   = 1008,
    // Level 3
    WC_MLDSA65_RSA3072k    = 1009,
    WC_MLDSA65_RSAPSS3072k = 1010,
    WC_MLDSA65_NISTP256k   = 1011,
    WC_MLDSA65_BPOOL256k   = 1012,
    WC_MLDSA65_ED25519k    = 1013,
    // Level 5
    WC_MLDSA87_NISTP384k   = 1014,
    WC_MLDSA87_BPOOL384k   = 1015,
    WC_MLDSA87_ED448k      = 1016,
};
