...
#define MLDSA_COMPOSITE_MAX_KEY_SIZE     DILITHIUM_LEVEL5_KEY_SIZE + ECC_MAXSIZE + 12
#define MLDSA_COMPOSITE_MIN_SIG_SIZE     MLDSA_ED25519_SIG_SIZE
#define MLDSA_COMPOSITE_MAX_SIG_SIZE     DILITHIUM_LEVEL5_SIG_SIZE + ECC_MAXSIZE + 12

#define MLDSA_COMPOSITE_MIN_PUB_KEY_SIZE MLDSA44_ED25519_PUB_KEY_SIZE
#define MLDSA_COMPOSITE_MAX_PUB_KEY_SIZE DILITHIUM_LEVEL5_PUB_KEY_SIZE + ECC_MAXSIZE + 12
#define MLDSA_COMPOSITE_MIN_PRV_KEY_SIZE MLDSA44_ED25519_PRV_KEY_SIZE
#define MLDSA_COMPOSITE_MAX_PRV_KEY_SIZE DILITHIUM_LEVEL5_PRV_KEY_SIZE + ECC_MAXSIZE + 12
