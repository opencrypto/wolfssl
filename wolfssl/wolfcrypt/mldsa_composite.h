...
#define MLDSA44_RSA2048_KEY_SIZE        DILITHIUM_SEED_SZ + RSA2048_KEY_SIZE
#define MLDSA44_RSA2048_SIG_SIZE        ML_DSA_LEVEL2_SIG_SIZE + RSA2048_SIG_SIZE
#define MLDSA44_RSA2048_PUB_KEY_SIZE    ML_DSA_LEVEL2_PUB_KEY_SIZE + RSA2048_PUB_KEY_SIZE
#define MLDSA44_RSA2048_PRV_KEY_SIZE    ML_DSA_LEVEL2_PRV_KEY_SIZE + RSA2048_PRV_KEY_SIZE

#define MLDSA44_NISTP256_KEY_SIZE       DILITHIUM_SEED_SZ + 32
#define MLDSA44_NISTP256_SIG_SIZE       ML_DSA_LEVEL2_SIG_SIZE + 72
#define MLDSA44_NISTP256_PUB_KEY_SIZE   ML_DSA_LEVEL2_PUB_KEY_SIZE + 64
...
#define MLDSA44_ED25519_KEY_SIZE       DILITHIUM_SEED_SZ + ED25519_KEY_SIZE
#define MLDSA44_ED25519_SIG_SIZE       ML_DSA_LEVEL2_SIG_SIZE + ED25519_SIG_SIZE
#define MLDSA44_ED25519_PUB_KEY_SIZE   ML_DSA_LEVEL2_PUB_KEY_SIZE + ED25519_PUB_KEY_SIZE
#define MLDSA44_ED25519_PRV_KEY_SIZE   MLDSA44_ED25519_KEY_SIZE

#define MLDSA44_BPOOL256_KEY_SIZE      DILITHIUM_SEED_SZ + 32 
#define MLDSA44_BPOOL256_SIG_SIZE      ML_DSA_LEVEL2_SIG_SIZE + 72
#define MLDSA44_BPOOL256_PUB_KEY_SIZE  ML_DSA_LEVEL2_PUB_KEY_SIZE + 64
...
#define MLDSA65_NISTP256_KEY_SIZE           DILITHIUM_SEED_SZ + 32
#define MLDSA65_NISTP256_SIG_SIZE           ML_DSA_LEVEL3_SIG_SIZE + 72
#define MLDSA65_NISTP256_PUB_KEY_SIZE       ML_DSA_LEVEL3_PUB_KEY_SIZE + 64 
#define MLDSA65_NISTP256_PRV_KEY_SIZE       MLDSA65_NISTP256_KEY_SIZE + 32

#define MLDSA65_ED25519_KEY_SIZE       DILITHIUM_SEED_SZ + ED25519_KEY_SIZE
#define MLDSA65_ED25519_SIG_SIZE       ML_DSA_LEVEL3_SIG_SIZE + ED25519_SIG_SIZE
#define MLDSA65_ED25519_PUB_KEY_SIZE   ML_DSA_LEVEL3_PUB_KEY_SIZE + ED25519_PUB_KEY_SIZE
#define MLDSA65_ED25519_PRV_KEY_SIZE   MLDSA65_ED25519_KEY_SIZE

#define MLDSA65_RSA3072_KEY_SIZE       DILITHIUM_SEED_SZ + RSA3072_KEY_SIZE
#define MLDSA65_RSA3072_SIG_SIZE       ML_DSA_LEVEL3_SIG_SIZE + RSA3072_SIG_SIZE
#define MLDSA65_RSA3072_PUB_KEY_SIZE   ML_DSA_LEVEL3_PUB_KEY_SIZE + RSA3072_PUB_KEY_SIZE
#define MLDSA65_RSA3072_PRV_KEY_SIZE   MLDSA65_RSA3072_KEY_SIZE

#define MLDSA65_RSA4096_KEY_SIZE       DILITHIUM_SEED_SZ + RSA4096_PRV_KEY_SIZE
#define MLDSA65_RSA4096_SIG_SIZE       ML_DSA_LEVEL3_SIG_SIZE + RSA4096_SIG_SIZE
#define MLDSA65_RSA4096_PUB_KEY_SIZE   ML_DSA_LEVEL3_PUB_KEY_SIZE + RSA4096_PUB_KEY_SIZE
#define MLDSA65_RSA4096_PRV_KEY_SIZE   MLDSA65_RSA4096_KEY_SIZE

#define MLDSA87_NISTP384_KEY_SIZE      DILITHIUM_SEED_SZ + 48
#define MLDSA87_NISTP384_SIG_SIZE      ML_DSA_LEVEL5_SIG_SIZE + 96
#define MLDSA87_NISTP384_PUB_KEY_SIZE  ML_DSA_LEVEL5_PUB_KEY_SIZE + ECC_MAXSIZE
#define MLDSA87_NISTP384_PRV_KEY_SIZE  MLDSA87_NISTP384_KEY_SIZE

#define MLDSA87_ED448_KEY_SIZE         DILITHIUM_SEED_SZ + ED448_KEY_SIZE
#define MLDSA87_ED448_SIG_SIZE         ML_DSA_LEVEL5_SIG_SIZE + ED448_SIG_SIZE
#define MLDSA87_ED448_PUB_KEY_SIZE     ML_DSA_LEVEL5_PUB_KEY_SIZE + ED448_PUB_KEY_SIZE
...
#define MLDSA_COMPOSITE_MAX_KEY_SIZE   ML_DSA_LEVEL5_KEY_SIZE + MLDSA_COMPOSITE_MAX_OTHER_KEY_SZ
#define MLDSA_COMPOSITE_MIN_SIG_SIZE   MLDSA44_ED25519_SIG_SIZE
#define MLDSA_COMPOSITE_MAX_SIG_SIZE   ML_DSA_LEVEL5_SIG_SIZE + MLDSA_COMPOSITE_MAX_OTHER_SIG_SZ
...
#define MLDSA_COMPOSITE_MAX_PRV_KEY_SIZE MLDSA65_RSA4096_KEY_SIZE
...
/* Export the private key (only) for the MLDSA Composite.
* @param [in]      key     mldsa_composite private key.
* @param [out]     out     Array to hold private key.
* @param [in, out] outLen  On in, the number of bytes in array.
*                          On out, the number bytes put into array.
...
* @return  BAD_FUNC_ARG when a parameter is NULL.
*/
WOLFSSL_API int wc_mldsa_composite_export_private_only(const mldsa_composite_key* key, byte* out, word32* outLen);
