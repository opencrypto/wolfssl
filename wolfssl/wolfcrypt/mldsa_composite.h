...
#define RSA2048_PUB_KEY_SIZE            256
#define RSA2048_PRV_KEY_SIZE            256

#define RSA3072_KEY_SIZE                384
#define RSA3072_SIG_SIZE                384
#define RSA3072_PUB_KEY_SIZE            384
#define RSA3072_PRV_KEY_SIZE            384
...
#define MLDSA44_ED25519_PRV_KEY_SIZE   DILITHIUM_ML_DSA_44_PRV_KEY_SIZE + ED25519_PRV_KEY_SIZE + 12
...
#define MLDSA44_BPOOL256_PRV_KEY_SIZE  DILITHIUM_ML_DSA_44_KEY_SIZE + 32 + 12
...
#define MLDSA65_NISTP256_KEY_SIZE           DILITHIUM_ML_DSA_65_KEY_SIZE + 32 + 12
#define MLDSA65_NISTP256_SIG_SIZE           DILITHIUM_ML_DSA_65_SIG_SIZE + 72 + 12
#define MLDSA65_NISTP256_PUB_KEY_SIZE       DILITHIUM_ML_DSA_65_PUB_KEY_SIZE + 64 + 12
#define MLDSA65_NISTP256_PRV_KEY_SIZE       DILITHIUM_ML_DSA_44_PRV_KEY_SIZE + 32 + 12

#define MLDSA65_ED25519_KEY_SIZE       DILITHIUM_ML_DSA_65_KEY_SIZE + ED25519_KEY_SIZE + 12
#define MLDSA65_ED25519_SIG_SIZE       DILITHIUM_ML_DSA_65_SIG_SIZE + ED25519_SIG_SIZE + 12
#define MLDSA65_ED25519_PUB_KEY_SIZE   DILITHIUM_ML_DSA_65_PUB_KEY_SIZE + ED25519_PUB_KEY_SIZE + 12
#define MLDSA65_ED25519_PRV_KEY_SIZE   DILITHIUM_ML_DSA_65_PRV_KEY_SIZE + ED25519_PRV_KEY_SIZE + 12

#define MLDSA65_RSA3072_KEY_SIZE       DILITHIUM_ML_DSA_65_KEY_SIZE + RSA3072_KEY_SIZE + 12
#define MLDSA65_RSA3072_SIG_SIZE       DILITHIUM_ML_DSA_65_SIG_SIZE + RSA3072_SIG_SIZE + 12
#define MLDSA65_RSA3072_PUB_KEY_SIZE   DILITHIUM_ML_DSA_65_PUB_KEY_SIZE + RSA3072_PUB_KEY_SIZE + 12
#define MLDSA65_RSA3072_PRV_KEY_SIZE   DILITHIUM_ML_DSA_65_KEY_SIZE + RSA3072_PRV_KEY_SIZE + 12

#define MLDSA65_RSA4096_KEY_SIZE       DILITHIUM_ML_DSA_65_KEY_SIZE + RSA4096_KEY_SIZE + 12
#define MLDSA65_RSA4096_SIG_SIZE       DILITHIUM_ML_DSA_65_SIG_SIZE + RSA4096_SIG_SIZE + 12
#define MLDSA65_RSA4096_PUB_KEY_SIZE   DILITHIUM_ML_DSA_65_PUB_KEY_SIZE + RSA4096_PUB_KEY_SIZE + 12
#define MLDSA65_RSA4096_PRV_KEY_SIZE   DILITHIUM_ML_DSA_65_KEY_SIZE + RSA4096_PRV_KEY_SIZE + 12

#define MLDSA87_NISTP384_KEY_SIZE      DILITHIUM_ML_DSA_87_KEY_SIZE + 48 + 12
#define MLDSA87_NISTP384_SIG_SIZE      DILITHIUM_ML_DSA_87_SIG_SIZE + 96 + 12
#define MLDSA87_NISTP384_PUB_KEY_SIZE  DILITHIUM_ML_DSA_87_PUB_KEY_SIZE + 64 + 12
#define MLDSA87_NISTP384_PRV_KEY_SIZE  DILITHIUM_ML_DSA_87_KEY_SIZE + 48 + 12

#define MLDSA87_ED448_KEY_SIZE         DILITHIUM_ML_DSA_87_KEY_SIZE + ED448_KEY_SIZE + 12
#define MLDSA87_ED448_SIG_SIZE         DILITHIUM_ML_DSA_87_SIG_SIZE + ED448_SIG_SIZE + 12
#define MLDSA87_ED448_PUB_KEY_SIZE     DILITHIUM_ML_DSA_87_PUB_KEY_SIZE + ED448_PUB_KEY_SIZE + 12
#define MLDSA87_ED448_PRV_KEY_SIZE     DILITHIUM_ML_DSA_87_PRV_KEY_SIZE + ED448_PRV_KEY_SIZE + 12
...
#define MLDSA_COMPOSITE_MAX_KEY_SIZE   DILITHIUM_LEVEL5_KEY_SIZE + MLDSA_COMPOSITE_MAX_OTHER_KEY_SZ + 12
#define MLDSA_COMPOSITE_MIN_SIG_SIZE   MLDSA_ED25519_SIG_SIZE
#define MLDSA_COMPOSITE_MAX_SIG_SIZE   DILITHIUM_LEVEL5_SIG_SIZE + MLDSA_COMPOSITE_MAX_OTHER_SIG_SZ + 12

#define MLDSA_COMPOSITE_MIN_PUB_KEY_SIZE MLDSA44_ED25519_PUB_KEY_SIZE
#define MLDSA_COMPOSITE_MAX_PUB_KEY_SIZE DILITHIUM_LEVEL5_PUB_KEY_SIZE + MLDSA_COMPOSITE_MAX_OTHER_KEY_SZ + 12
#define MLDSA_COMPOSITE_MIN_PRV_KEY_SIZE MLDSA44_ED25519_PRV_KEY_SIZE
#define MLDSA_COMPOSITE_MAX_PRV_KEY_SIZE DILITHIUM_LEVEL5_PRV_KEY_SIZE + MLDSA_COMPOSITE_MAX_OTHER_KEY_SZ + 12
