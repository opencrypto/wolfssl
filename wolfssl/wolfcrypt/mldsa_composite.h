...
#define MLDSA44_P256_KEY_SIZE       DILITHIUM_ML_DSA_44_KEY_SIZE + ECC_MAXSIZE + MLDSA_COMPOSITE_MAX_SEQUENCE_DER_SIZE
#define MLDSA44_P256_SIG_SIZE       DILITHIUM_ML_DSA_44_SIG_SIZE + ECC_MAX_SIG_SIZE + MLDSA_COMPOSITE_MAX_SEQUENCE_DER_SIZE
#define MLDSA44_P256_PUB_KEY_SIZE   DILITHIUM_ML_DSA_44_PUB_KEY_SIZE + ECC_MAXSIZE + MLDSA_COMPOSITE_MAX_SEQUENCE_DER_SIZE
...
#define MLDSA44_ED25519_SIG_SIZE       DILITHIUM_ML_DSA_44_SIG_SIZE + ED25519_SIG_SIZE + MLDSA_COMPOSITE_MAX_SEQUENCE_DER_SIZE
...
#define MLDSA_COMPOSITE_MAX_KEY_SIZE     DILITHIUM_LEVEL5_KEY_SIZE + ECC_MAXSIZE + MLDSA_COMPOSITE_MAX_SEQUENCE_DER_SIZE
#define MLDSA_COMPOSITE_MAX_SIG_SIZE     DILITHIUM_LEVEL5_SIG_SIZE + ECC_MAXSIZE + MLDSA_COMPOSITE_MAX_SEQUENCE_DER_SIZE
#define MLDSA_COMPOSITE_MAX_PUB_KEY_SIZE DILITHIUM_LEVEL5_PUB_KEY_SIZE + ECC_MAXSIZE + MLDSA_COMPOSITE_MAX_SEQUENCE_DER_SIZE
#define MLDSA_COMPOSITE_MAX_PRV_KEY_SIZE DILITHIUM_LEVEL5_PRV_KEY_SIZE + ECC_MAXSIZE + MLDSA_COMPOSITE_MAX_SEQUENCE_DER_SIZE
